...
from app.agents.debate.advocate import AdvocateAgent
from app.agents.debate.critic import CriticAgent
from app.agents.debate.judge import JudgeAgent
from app.config import Settings, get_settings
from app.logging_config import get_logger
from app.models.debate import DebateResult, DebateRound
...
class DebateOrchestrator:
    ...
    async def run(self, state: dict[str, Any]) -> dict[str, Any]:
        ...
        # Langfuse trace 생성
        from app.monitoring.langfuse_handler import create_trace
        ...
        # Prometheus 메트릭
        from app.monitoring.metrics import observe_debate
