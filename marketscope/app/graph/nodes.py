...
from app.monitoring.mcp_monitor import MCPMonitoringMiddleware
...
async def real_estate_node(state: dict[str, Any]) -> dict[str, Any]:
    """부동산 분석 에이전트 노드."""
    from app.agents.real_estate import RealEstateAgent
...
async def debate_node(state: dict[str, Any]) -> dict[str, Any]:
    ...
    from app.agents.debate.orchestrator import DebateOrchestrator
