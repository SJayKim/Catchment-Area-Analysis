...
async def detailed_health() -> dict[str, Any]:
    ...
    mcp_stats = {}
    try:
        from marketscope_agent.graph.nodes import _mcp_monitor
    ...
    dag_timings = {}
    try:
        from marketscope_common.monitoring.dag_tracer import get_dag_tracer
...
async def _check_redis() -> dict[str, Any]:
    """Redis 연결 상태 확인."""
    try:
        from marketscope_common.cache.redis_client import health_check
...
async def _check_mcp_servers() -> dict[str, Any]:
    """MCP 서버 상태 확인."""
    try:
        from marketscope_agent.graph.nodes import _mcp_monitor, _mcp_router
