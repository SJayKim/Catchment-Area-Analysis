...
from marketscope_agent.engine.redis_broker import RedisBroker
...
class EngineWorker:
    ...
    async def _process_request(self, request: dict[str, Any]) -> None:
        ...
        # LangGraph 실행
        from marketscope_agent.services.analysis_service import AnalysisService
...
async def main() -> None:
    ...
    from marketscope_agent.graph.nodes import _get_mcp_router
    _get_mcp_router()
