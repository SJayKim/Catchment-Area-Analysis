...
> MarketScope AI 테스트 전략, 운영 가이드, 성능 벤치마크 통합 문서
> 작성일: 2026-03-21
...
### Part 2: 운영 & 트러블슈팅
11. [로깅 전략](#11-로깅-전략)
12. [모니터링 대시보드](#12-모니터링-대시보드)
13. [알림 규칙](#13-알림-규칙)
14. [장애 유형 & 디버깅](#14-장애-유형--디버깅)
15. [백업 & 복구](#15-백업--복구)
16. [인시던트 대응 런북](#16-인시던트-대응-런북)

### Part 3: 성능 벤치마크 & SLA
17. [분석 모드별 응답 시간 목표](#17-분석-모드별-응답-시간-목표)
18. [API 엔드포인트 SLA](#18-api-엔드포인트-sla)
19. [LLM 비용 목표](#19-llm-비용-목표)
20. [동시 처리 용량 & 수평 확장](#20-동시-처리-용량--수평-확장)
21. [성능 튜닝](#21-성능-튜닝)
22. [DB 쿼리 성능](#22-db-쿼리-성능)
23. [MCP 서버 성능](#23-mcp-서버-성능)
24. [부하 테스트 시나리오](#24-부하-테스트-시나리오)

### 부록
- [A. pytest 마커 정의](#a-pytest-마커-정의)
- [B. 테스트 네이밍 규칙](#b-테스트-네이밍-규칙)
- [C. 모킹 체크리스트](#c-모킹-체크리스트)
- [D. 참고 문서](#d-참고-문서)
...
| **Comparison** | ~18 (Basic x 2 locations + comparison) | 60초 | 120초 | 180초 |
...
| `debate` (3라운드) | 15-30 | 9 | Advocate+Critic+Judge x 3 |
